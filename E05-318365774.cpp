...
int main()
{
	...
	PataInfDer = Model();
	PataInfDer.LoadModel("Models/PataInfDer.obj");
	PataInfIzq = Model();
	PataInfIzq.LoadModel("Models/PataInfIzq.obj");
	PataSupDer = Model();
	PataSupDer.LoadModel("Models/PataSupDer.obj");
	PataSupIzq = Model();
	PataSupIzq.LoadModel("Models/PataSupIzq.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Presionar F para cerrar la mandibula y G para abrir
		...
		color = glm::vec3(1.0f, 0.0f, 0.0f); //Cambiar colores a las patas
		modelaux = model;
		model = glm::translate(model, glm::vec3(7.3f, 2.2f, -8.8f));
		//Presionar H y J para rotar esta pata
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataSupDer.RenderModel();
		model = modelaux;

		// pata delantera izquierda
		modelaux = model;
		model = glm::translate(model, glm::vec3(7.2f, 2.2f, -10.2f));
		//Presionar K y L para rotar esta pata
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataSupIzq.RenderModel();
		model = modelaux;

		//pata trasera derecha
		modelaux = model;
		model = glm::translate(model, glm::vec3(5.5f, 1.55f, -8.8f));
		//Presionar O y P para rotar esta pata
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataInfDer.RenderModel();
		model = modelaux;

		//pata trasera izquierda
		modelaux = model;
		model = glm::translate(model, glm::vec3(5.5f, 1.55f, -10.2f));
		//Presionar U e I para rotar esta pata
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		PataInfIzq.RenderModel();
		model = modelaux;
